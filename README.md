# [SOLVED] Why Is This Program Valid I Was Trying To Create A Syntax Er
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/why-is-this-program-valid-i-was-trying-to-create-a-syntax-er)

---

### 🔍 Quick Technical Overview & Summary:
The code is valid because the 'Syntax error!' message is not a syntax error itself, but rather a string literal. The use of 'use strict' and 'warnings' ensures that the rest of the code adheres to Perl's syntax rules.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/why-is-this-program-valid-i-was-trying-to-create-a-syntax-er)**
